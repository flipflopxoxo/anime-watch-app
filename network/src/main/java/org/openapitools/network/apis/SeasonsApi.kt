...
import org.openapitools.network.models.Seasons
...
interface SeasonsApi {
    ...
    */
    enum class FilterGetSeason(val value: String) {
    ...
    suspend fun getSeason(@Path("year") year: Int, @Path("season") season: String, @Query("filter") filter: FilterGetSeason? = null, @Query("sfw") sfw: Boolean? = null, @Query("unapproved") unapproved: Boolean? = null, @Query("continuing") continuing: Boolean? = null, @Query("page") page: Int? = null, @Query("limit") limit: Int? = null): Response<AnimeSearch>
    ...
    * enum for parameter filter
    */
    enum class FilterGetSeasonUpcoming(val value: String) {
        @SerializedName(value = "tv") tv("tv"),
        @SerializedName(value = "movie") movie("movie"),
        @SerializedName(value = "ova") ova("ova"),
        @SerializedName(value = "special") special("special"),
    ...
    suspend fun getSeasonUpcoming(@Query("filter") filter: FilterGetSeasonUpcoming? = null, @Query("sfw") sfw: Boolean? = null, @Query("unapproved") unapproved: Boolean? = null, @Query("continuing") continuing: Boolean? = null, @Query("page") page: Int? = null, @Query("limit") limit: Int? = null): Response<AnimeSearch>
     ...
     */
    @GET("seasons")
    suspend fun getSeasonsList(): Response<Seasons>
